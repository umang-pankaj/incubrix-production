...
export default function Team() {
  ...
  const leadershipTeam = [
    ...
    },
    {
      ...
      bio: 'Leading operations and customer success to maximize creator value.'
    },
    {
      ...
      bio: 'Product leader focused on building intuitive, powerful tools for the creator economy.'
    }
  ];
  ...
  const advisoryTeam = [
    {
      ...
      bio: 'Growth strategy and continuous innovation advisor.'
    },
    {
      name: 'Gaurav Anand',
      position: 'Commercial & Enterprise Strategy Advisory',
      linkedin: 'https://www.linkedin.com/in/gauravanand86/',
      image: 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=400&q=80',
      bio: 'Driving enterprise scale and commercial alignment.'
    },
    {
      name: 'Abhinava Srivastava',
      position: 'Commercial & Payment Solutions Advisory',
      linkedin: 'https://www.linkedin.com/in/abhinavasrivastava/',
      image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&q=80',
      bio: 'FinTech and commercial integrations maestro.'
    },
    {
      ...
      bio: 'Strategic technological roadmap and engineering innovation.'
    }
  ];

  const TeamCard = ({ member }) => (
    <Card className="bg-gradient-to-br from-[#151d45] to-[#0a0e27] border-cyan-500/20 overflow-hidden hover:border-cyan-500/60 transition-all group relative h-full flex flex-col hover:-translate-y-2 duration-300">
      <motion.div className="absolute inset-0 bg-gradient-to-br from-cyan-500/0 to-blue-500/0 group-hover:from-cyan-500/10 group-hover:to-blue-500/10 transition-all duration-300" />
      <motion.div className="absolute -inset-1 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-t-xl opacity-0 group-hover:opacity-40 blur-xl transition-opacity duration-500" />
      <div className="aspect-square overflow-hidden relative shrink-0">
        ...
        <img
          src={member.image}
          alt={member.name}
          className="w-full h-full object-cover relative z-10 mix-blend-lighten grayscale-[20%] group-hover:grayscale-0 transition-all duration-500"
        />
      ...
      <div className="p-6 relative z-10 flex flex-col flex-1">
        ...
        <p className="text-cyan-400 font-semibold mb-3 tracking-wide text-sm">{member.position}</p>
        <p className="text-gray-400 text-sm mb-6 leading-relaxed flex-1">{member.bio}</p>
        <a
          href={member.linkedin}
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-2 text-cyan-400 hover:text-cyan-300 transition-colors group/link mt-auto w-fit"
        >
          ...
          <span className="border-b border-cyan-400/0 group-hover/link:border-cyan-400/100 transition-all font-medium text-sm">
            LinkedIn Profile
          </span>
        </a>
      </div>
